...
> Sistema web que optimiza el proceso de matrícula universitaria mediante la generación automática de horarios para estudiantes y la planificación inteligente de aulas para docentes.
...
- 📆 [Cronograma del Proyecto](docs/cronograma-SIMA.png)
- ⚠️ [Registro de Riesgos](docs/registro-riesgos.md)
- 🌟 [Registro de Oportunidades](docs/registro-oportunidades.md)
...
- 🗄️ [Diagrama Entidad-Relación](docs/diagrama-entidad-relacion.md)
- ⚙️ [Desarrollo del Algoritmo](docs/Desarrollo-del-algoritmo.md)
...
- 📈 [Informe de Estado del Proyecto](docs/informe_estado2.md)
- 🚧 [Registro de Impedimentos](docs/impedimentos.md)
- 🤝 [Minuta de Reunión 1](docs/minuta-reunion.md)
...
- ✅ [Revisión del Sprint](docs/revision-sprint.md)
- 🔄 [Retrospectiva del Sprint](docs/retrospectiva-sprint.md)

---
# 📊 Calidad y Validación

- 🔍 [Análisis de Calidad de Código (SonarQube)](docs/analisis_Sonarqube.md)
- 📈 [Interpretación de Métricas de Calidad](docs/interpretacion_metricas.md)
